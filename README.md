...
*   **F5-TTS Integration**: One-shot voice cloning from a 3–10 second speaker reference.
...
├── backend/                  # DSP core, model wrappers, FastAPI server routes
├── docs/                     # Academic specs, designs, and quality audit logs
│   ├── deepfake-SRS.pdf
│   ├── dsp_sdd.pdf
│   └── CHANGES.txt
├── frontend/                 # Glassmorphic HTML5 / Vanilla JS UI client
├── tests/                    # Automation verification & testing scripts
...
├── logs_and_temp/            # Crash logs, installation logs, and debug reports
│   ├── 4.57
│   ├── crash.log
│   ├── test_metrics.csv
│   └── the domain.txt
